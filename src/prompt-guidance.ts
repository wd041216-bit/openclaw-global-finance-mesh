...
- Emit one auditable Decision Packet, not scattered finance guesses.
- Name the matched packs and rule versions behind every recommendation.
- Escalate when confidence is low, evidence is missing, rules conflict, or risk is high.
