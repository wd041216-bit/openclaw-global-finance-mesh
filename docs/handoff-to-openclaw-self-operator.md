...
- Repo: [openclaw-global-finance-mesh](https://github.com/wd041216-bit/openclaw-global-finance-mesh)
- Default branch: `main`
...
- runtime server: [src/server.ts](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/src/server.ts)
- LLM runtime: [src/brain.ts](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/src/brain.ts)
- legal library: [src/legal-library.ts](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/src/legal-library.ts)
- finance engine: [src/engine.ts](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/src/engine.ts)
- web console: [web/index.html](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/web/index.html)
- runtime config: [src/runtime-config.ts](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/src/runtime-config.ts)
...
1. Read:
   - [README.md](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/README.md)
   - [docs/enterprise-readiness.md](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/docs/enterprise-readiness.md)
   - [docs/long-term-evolution-plan.md](/Users/dawei/Documents/New%20project/openclaw-global-finance-mesh/docs/long-term-evolution-plan.md)
2. Run:
   - `npm install`
   - `npm test`
   - `npm run dev`
...
Add enterprise control surfaces.

- auth and role boundaries
- audit persistence that survives restarts
...
```text
Use openclaw-self-operator and take over /Users/dawei/Documents/New project/openclaw-global-finance-mesh as an actively evolving product. Start by reading docs/handoff-to-openclaw-self-operator.md and docs/long-term-evolution-plan.md, then verify the runtime locally before making the next highest-leverage enterprise improvement.
```
